...
# 설정
THRESHOLD = 0.40
centroid = np.load("C:/Users/nsjic/Downloads/centroid_jw.npy")
...
# ----------------------------
# 폴더 생성
os.makedirs("C:/Users/nsjic/OneDrive/바탕 화면/before_blur", exist_ok=True)
os.makedirs("C:/Users/nsjic/OneDrive/바탕 화면/after_blur", exist_ok=True)

# ----------------------------
# 모델 초기화
# 수정 코드 (동영상 입력)
video_path = r"C:/Users/nsjic/OneDrive/바탕 화면/text_video.mp4"
...
def mosaic_mask(img, mask, scale=0.05):
    ...
    mask_3d = (mask_resized > 0.5).astype(np.uint8)[:, :, None]
    ...
    if results.masks is not None:
        ...
        for mask, cls, box in zip(masks, classes, boxes):
            ...
            if cos_sim < THRESHOLD:
                ...
                before_path = os.path.join("C:/Users/nsjic/OneDrive/바탕 화면/before_blur", save_name)
                after_path = os.path.join("C:/Users/nsjic/OneDrive/바탕 화면/after_blur", save_name)
...
# 평가 실행
gt = np.load("C:/Users/nsjic/OneDrive/frames/gt_texts.npy")   
...
save_path = "C:/Users/nsjic/Downloads/gt_labels.npy"
...
def smart_evaluation():
    pred_path = "C:/Users/nsjic/OneDrive/바탕 화면/pred_labels.npy"
    gt_path = "C:/Users/nsjic/OneDrive/바탕 화면/gt_labels.npy"
    ...
    acc_before = compute_accuracy("C:/Users/nsjic/OneDrive/바탕 화면/before_blur", centroid, THRESHOLD)
    acc_after = compute_accuracy("C:/Users/nsjic/OneDrive/바탕 화면/after_blur", centroid, THRESHOLD)
